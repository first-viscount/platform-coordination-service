...
class TestServiceRegistration:
    ...
    @pytest.mark.asyncio
    async def test_register_new_service(self, test_client: AsyncClient, sample_service_data):
        """Test registering a new service."""
        response = await test_client.post("/api/v1/services/register", json=sample_service_data)
    ...
    @pytest.mark.asyncio
    async def test_register_duplicate_service(self, test_client: AsyncClient, sample_service_data):
        """Test that re-registering the same service updates it."""
        # Register first time
        response1 = await test_client.post("/api/v1/services/register", json=sample_service_data)
        ...
        response2 = await test_client.post("/api/v1/services/register", json=updated_data)
...
class TestConcurrentOperations:
    ...
    async def test_concurrent_registrations(self, test_client: AsyncClient):
        ...
        concurrent_services = [s for s in services if s["name"].startswith("concurrent-")]
        assert len(concurrent_services) == 10
    
    @pytest.mark.asyncio
    async def test_concurrent_updates_same_service(self, test_client: AsyncClient, sample_service_data):
...
class TestOptimisticLocking:
    ...
    @pytest.mark.asyncio
    async def test_version_increment_on_update(self, test_client: AsyncClient, db_session, sample_service_data):
        ...
        await test_client.post(f"/api/v1/services/{service_id}/health", params={"healthy": True})
        ...
        # Another update
        await test_client.post(f"/api/v1/services/{service_id}/health", params={"healthy": False})
...
class TestServiceDiscovery:
    ...
    @pytest.mark.asyncio
    async def test_list_all_services(self, test_client: AsyncClient, multiple_services_data):
    ...
    @pytest.mark.asyncio
    async def test_filter_by_type(self, test_client: AsyncClient, multiple_services_data):
    ...
    @pytest.mark.asyncio
    async def test_filter_by_tag(self, test_client: AsyncClient, multiple_services_data):
        ...
        # Filter by tag
        response = await test_client.get("/api/v1/services/", params={"tag": "env=prod"})
        services = response.json()
    ...
    @pytest.mark.asyncio
    async def test_discover_by_name(self, test_client: AsyncClient, sample_service_data):
        ...
        # Discover by name
        response = await test_client.get(f"/api/v1/services/discover/{sample_service_data['name']}")
    ...
    async def test_discover_excludes_unhealthy(self, test_client: AsyncClient):
        ...
        response1 = await test_client.post("/api/v1/services/register", json=service_data)
        service1_id = response1.json()["id"]
        
        # Register second instance
        service_data["host"] = "host2"
        response2 = await test_client.post("/api/v1/services/register", json=service_data)
        service2_id = response2.json()["id"]
        
        # Make first healthy, second unhealthy
        await test_client.post(f"/api/v1/services/{service1_id}/health", params={"healthy": True})
        await test_client.post(f"/api/v1/services/{service2_id}/health", params={"healthy": False})
...
class TestHealthChecks:
    ...
    @pytest.mark.asyncio
    async def test_health_check_updates_status(self, test_client: AsyncClient, sample_service_data):
        ...
        response = await test_client.post(f"/api/v1/services/{service_id}/health", params={"healthy": True})
        assert response.status_code == 200
        ...
        response = await test_client.post(f"/api/v1/services/{service_id}/health", params={"healthy": False})
        updated = response.json()
...
class TestAuditTrail:
    ...
    @pytest.mark.asyncio
    async def test_service_events_logged(self, test_client: AsyncClient, db_session, sample_service_data):
